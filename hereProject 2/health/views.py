...
def jamaGymevent(request):
    # 헬스장 리뷰
    return render(request, 'jamaGymevent.html')

def jamaGymopen(request):
    # 헬스장 리뷰
    return render(request, 'jamaGymopen.html')

def jamaGymprice(request):
    # 헬스장 리뷰
    return render(request, 'jamaGymprice.html')

def jamaGymcall(request):
    # 헬스장 리뷰
    return render(request, 'jamaGymcall.html')

def gym(request):
    places = gymPlace.objects.all()
    return render(request, 'gym.html', {'places': places})

def visitorreview(request):
    reviews = gymReview.objects.all()
    return render(request, "visitorreview.html", {'reviews': reviews})
